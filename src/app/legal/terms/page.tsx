  ...
  return (
    <div style={{ background: '#0E0E0E', color: '#E5E2E1', fontFamily: "'Inter', sans-serif", minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px 100px' }}>
        ...
        <p style={{ fontSize: 15, color: '#8B8AA3', marginBottom: 48, lineHeight: 1.7 }}>Please read these terms carefully before using VangelClip. By accessing or using our services, you agree to be bound by these terms.</p>

        {[
          { title: '1. Acceptance of Terms', body: 'By accessing or using VangelClip ("Service"), you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this Service.' },
