    ...
    <div style={{ background: '#0E0E0E', color: '#E5E2E1', fontFamily: "'Inter', sans-serif", minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px 100px' }}>
        ...
        {[
          ...
          { title: '4. Content and Intellectual Property', body: 'You retain all ownership rights to the original content you upload or process through VangelClip. By using our Service, you grant VangelClip a limited, non-exclusive licence to process, store, and display your content solely for the purpose of providing the Service. You represent and warrant that you own or have the necessary licences, rights, consents, and permissions to upload, process, and distribute any content you submit through the Service, and that your use does not infringe any third-party intellectual property rights. You are solely responsible for ensuring you hold all required rights before uploading any content. Uploading, processing, or distributing content for which you do not hold the necessary rights is strictly prohibited and may result in immediate account suspension and termination.' },
          { title: '5. Acceptable Use', body: 'You agree not to use the Service to upload, generate, or distribute content that: (a) you do not own or do not have the necessary licence, permission, or authorisation to use — uploading third-party copyrighted material without rights is strictly prohibited; (b) contains hate speech, violence, or discriminatory material; (c) violates any applicable law or regulation; (d) constitutes spam or unsolicited communications; (e) contains malware, viruses, or harmful code. VangelClip reserves the right to remove content that violates these guidelines and to suspend accounts engaged in repeated or wilful rights violations.' },
