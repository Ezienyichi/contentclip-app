          ...
          <div key={clip.id ?? idx} style={{ background:colors.surfaceContainerHigh, borderRadius:radius.lg, overflow:'hidden' }}>
            ...
            <div style={{ padding:'12px' }}>
              ...
              <div style={{ display:'flex', gap:'6px' }}>
                ...
                <button onClick={() => router.push(`/scheduler?clip_id=${clip.id}&caption=${encodeURIComponent(clip.suggested_caption || '')}`)} disabled={!clip.id} title="Schedule this clip" style={{ padding:'8px 10px', borderRadius:radius.md, background:colors.surfaceContainer, border:'1px solid '+colors.outlineVariant, color:colors.onSurface, fontSize:'11px', fontWeight:600, cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'center', gap:'4px', fontFamily:"'Inter',sans-serif" }}>
