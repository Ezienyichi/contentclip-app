...
const PLANS = [
  ...
  },
  {
    ...
    cta: 'Choose Starter',
    includes: '300 minutes / month · Everything in Free, plus',
    features: [
  ...
  },
  {
    ...
    cta: 'Choose Pro',
    includes: '750 minutes / month · Everything in Starter, plus',
    features: [
      '750 minutes of processing / month',
      '4K Cinematic Export',
      'Background music library',
      'Priority processing',
      '4 social accounts',
  ...
  return (
    <div style={{ background:mkt.bg, color:mkt.text, fontFamily:mkt.fontBody, minHeight:'100vh' }}>
      ...
      <style>{`
        ...
        /* Trust strip logos */
        .vc-logos { display:flex; gap:38px; justify-content:center; flex-wrap:wrap; opacity:.55; font-family:'Hanken Grotesk',sans-serif; font-weight:700; font-size:18px; }
      ...
      <div style={{ borderTop:`1px solid ${mkt.border}`, borderBottom:`1px solid ${mkt.border}`, background:mkt.surface2 }}>
        <div style={{ maxWidth:1000, margin:'0 auto', padding:'26px 28px', textAlign:'center' }}>
          <div style={{ fontSize:12.5, fontWeight:600, letterSpacing:'.08em', textTransform:'uppercase', color:mkt.muted, marginBottom:16 }}>Used by creators across Africa</div>
          <div className="vc-logos">
            {['Preach It','DSTV','TBN Africa','Spotify','YouTube'].map(l => <span key={l}>{l}</span>)}
          </div>
        </div>
      </div>
